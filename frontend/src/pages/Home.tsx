...
export default function Home() {
  return (
    <div className="space-y-20">
      <section className="rounded-[32px] border border-slate-100 bg-white px-6 py-10 shadow-[0_40px_120px_rgba(12,38,131,0.1)] sm:px-10">
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <div className="mt-4 flex items-center justify-center gap-3 rounded-3xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-600 lg:justify-start">
          ...
          <div className="relative mt-6 lg:mt-0">
            ...
            <div className="mt-4 rounded-3xl bg-[#0B64FF] p-4 text-center text-white shadow-2xl md:absolute md:-right-6 md:-top-6 md:w-48 md:text-left">
            ...
            <div className="mt-4 rounded-3xl border border-slate-100 bg-white p-4 text-sm text-slate-600 shadow-xl md:absolute md:-left-6 md:-bottom-8 md:w-56">
      ...
      <section className="space-y-8 px-6 sm:px-10" id="visibility">
        ...
        <div className="relative rounded-[36px] border border-slate-100 bg-white p-4 shadow-[0_40px_120px_rgba(12,38,131,0.08)] sm:p-6">
          ...
          <div className="mt-6 rounded-3xl bg-[#0B64FF] p-6 text-white shadow-2xl md:absolute md:right-8 md:-top-10 md:w-64">
          ...
          <div className="mt-6 rounded-3xl border border-slate-100 bg-white p-5 text-sm text-slate-700 shadow-xl md:absolute md:left-8 md:-bottom-10 md:w-64">
      ...
      <section className="space-y-10">
        ...
        <div className="flex flex-wrap justify-center gap-4 overflow-x-auto text-sm font-semibold">
