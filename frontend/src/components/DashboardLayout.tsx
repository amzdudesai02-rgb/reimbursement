...
const sidebarItems: SidebarItem[] = [
  ...
  { type: 'link', icon: Link2, label: 'Reimbursement Tool', path: '/reimbursement-tool' },
...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const fbaSlotHeight = 48; // h-12 nav items
  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      <aside className="relative w-20 flex flex-col items-center py-6 flex-shrink-0 min-h-0 overflow-visible bg-slate-800 border-r border-slate-700/80 shadow-xl">
        ...
        <nav className="flex-1 min-h-0 flex flex-col items-center space-y-3 overflow-y-auto overflow-x-visible w-full py-2 scrollbar-hide">
